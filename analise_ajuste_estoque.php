...
//  echo $sel;
  ...
  if ( count( $res ) > 0 ) {
   ...
   echo "<table id='tblDin' class='tblFormPreco display'>";
...
*/
  ...
  // echo "<th title='Cobertura, dias de estoque'>Cober</th>";
   ...
   echo "<tbody>";
    ...
    echo "<td class='classColor3' style='text-align:center;font-weight: bold;'>";
    echo "<span title='" . Date( "d/m/y", strtotime( $data[ 0 ][ 'dtEmissao' ] ) ) . "'>";
    ...
    echo "<td class='classColor3' style='text-align:center;font-weight: bold;'>"; // exibe o % do estoque que está pago
...
/*
    ...
    echo "</td>";
*/
    echo "<td class='classColor1'; style='text-align:center; font-weight: bold;'>";
