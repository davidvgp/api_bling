...
$contas = $Class->getContas(1);  // 1 nesse caso é o id_user_app
    ...
    foreach ( $contas as $conta ) {  // repete o código para todas as contas.
        ...
        if ( count( $verif_cron ) > 0 ) {
            ...
            echo "<br>";
            echo "Tafera Cron Refresh Pedidos Itehs ATIVADA";
            echo "<br>";
            ...
            $sqlNumPedido = "SELECT id_bling FROM tb_vendas WHERE id_conta_bling =:ID_CONTA_BLING ORDER BY numero DESC LIMIT 50";
